...
if __name__ == "__main__":
    ...
    if create_plots:
        if pos_neg_ece:
            ...
            plt.savefig(os.path.join(save_plots_loc, 'pos_ece_acc_before_scaling_{}_{}'.format(dataset, args.model)), format='eps', dpi=40)
            plt.close()
            ...
            plt.savefig(os.path.join(save_plots_loc, 'neg_ece_acc_before_scaling_{}_{}'.format(dataset, args.model)), format='eps', dpi=40)
            plt.close()
        ...
        plt.xlabel('accuracy')
        plt.ylabel('ECE')
        plt.savefig(os.path.join(save_plots_loc, 'ece_acc_before_scaling_{}_{}'.format(dataset, args.model)), format='eps', dpi=40)
        plt.close()
    ...
    if const_temp:
        ...
        if create_plots:
            ...
            plt.ylabel('ECE')
            plt.savefig(os.path.join(save_plots_loc, 'ece_iters_{}_{}_{}'.format(init_temp, dataset, args.model)), format='eps', dpi=40)
            plt.close()
    ...
    if create_plots:
        if pos_neg_ece:
            ...
            plt.xlabel('accuracy')
            plt.ylabel('positive ECE')
            plt.savefig(os.path.join(save_plots_loc, 'pos_ece_acc_after_scaling_{}_{}'.format(dataset, args.model)), format='eps', dpi=40)
            plt.close()
            ...
            plt.xlabel('accuracy')
            plt.ylabel('negative ECE')
            plt.savefig(os.path.join(save_plots_loc, 'neg_ece_acc_after_scaling_{}_{}'.format(dataset, args.model)), format='eps', dpi=40)
            plt.close()
        ...
        plt.xlabel('accuracy')
        plt.ylabel('ECE')
        plt.savefig(os.path.join(save_plots_loc, 'ece_acc_after_scaling_{}_{}'.format(dataset, args.model)), format='eps', dpi=40)
